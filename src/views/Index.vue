<template lang="pug">
article.index
  header.mt-72.lg_mt-60.px-6.lg_pl-20.lg_pr-12.relative.z-10
    ...
    nav.flex.flex-wrap.text-md.justify-center.sm_justify-start.items-center
      ...
      template(v-if="$route.name === 'network-index'")
        .fixed.z-40.bottom-20.left-0.w-full.sm_static.sm_w-auto.flex-1.flex.justify-center.sm_justify-end.mt-4.sm_mt-0
          sort-dropdown-vue
